...
namespace StarterKit.Services;
    public interface IAttendanceService
    {
        ...
        public Task<bool> AddAttendance(User userId, DateTime attendanceDate);
        ...
        public Task<User?> GetLoggedInUser(string email);
        public Task<List<Attendance>> GetAttendancesByUserId(int? userId);
